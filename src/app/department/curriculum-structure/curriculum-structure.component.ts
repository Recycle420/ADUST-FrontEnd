...
@Component({
  selector: 'app-curriculum-structure',
  templateUrl: './curriculum-structure.component.html',
  styleUrls: ['./curriculum-structure.component.scss']
})
export class CurriculumStructureComponent implements OnInit {
