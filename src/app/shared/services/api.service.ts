...
export class ApiService {
  ...
  getFolders() {
    return this.http.get(environment.apiUrl + `/media/getFolders`, this.httpOptions);
  }
  getImages(mediaFolderId: number) {
    return this.http.get(environment.apiUrl + `/media/getImages/${mediaFolderId}`, this.httpOptions);
  }
  getVideos() {
    return this.http.get(environment.apiUrl + `/media/getVideos`, this.httpOptions);
  }
